  class Card {
    ...
    generateCard() {
      ...
      this._element.querySelector('.card_image').src = this._image;
      this._element.querySelector('.card_image').alt = this._alt;
      this._element.querySelector('.card_title').textContent = this._title;
